...
import { SetCurrentUserJwt } from "../utils/storageWrapper";
    ...
    return <>
        <div className="w-full max-w-xs">
            <form onSubmit={handleSubmit} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <label>
                    <input type="submit" name="Submit" value="Log In" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"/>
                </label>
